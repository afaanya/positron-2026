...
<body class="bg-white font-sans w-full overflow-x-hidden">
    <div class="w-full min-h-screen">

    {{-- Navbar --}}
    <nav class="flex flex-wrap items-center justify-between px-4 md:px-8 py-4 border-b border-gray-100">
        <div class="flex items-center gap-3">
            ...
            <div>
                <p class="text-sm font-semibold text-gray-800 leading-none">POSITRON 2026</p>
    ...
    {{-- Hero --}}
    <section class="bg-blue-50 text-center px-4 md:px-6 py-20">
    ...
    {{-- Stats --}}
    <div class="w-full grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-gray-100 border-y border-gray-100">
        @foreach([
    ...
    {{-- Fitur --}}
    <section id="fitur" class="px-4 md:px-8 py-16 max-w-6xl mx-auto">
