...
function updateClock() {
    ...
    // sudut detik dalam 0-360
    let secondAngle = sec * 6;

    // kalau habis lewat angka 12
    ...
    document.getElementById("js-second").style.transform =
        `rotate(${secondRotation}deg)`;

    document.getElementById("js-minute").style.transform =
        `rotate(${minuteRotation}deg)`;

    document.getElementById("js-hour").style.transform =
