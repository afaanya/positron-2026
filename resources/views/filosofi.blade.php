...
@section('content')
<div class="min-h-screen antialiased text-white" style="background:#0a1a10 url('{{ asset('images/bg card.webp') }}') center top / cover fixed no-repeat;">
    ...
    <div class="relative w-full max-w-[1230px] mx-auto px-4 py-10 lg:py-0">
        ...
        <div class="hidden lg:block relative w-full filosofi-board">
            ...
            <img src="{{ asset('images/filosofi.text.webp') }}" 
                 alt="Filosofi Text"
                 class="filosofi-title-img">

            <div class="filosofi-atas-item absolute">
                <img src="{{ asset('images/filosofi.atas.item.webp') }}"
                     alt="Filosofi Atas Item"
                     class="petir-glow"
                     data-black-src="{{ asset('images/filosofi.atas.item.webp') }}"
                     data-yellow-src="{{ asset('images/filosofi.atas.kuning.webp') }}">
            ...
            <div class="filosofi-bawah-item absolute">
                ...
                <img src="{{ asset('images/filosofi.bawah.item.webp') }}"
                     alt="Filosofi Bawah Item"
                     class="petir-glow"
                     data-black-src="{{ asset('images/filosofi.bawah.item.webp') }}"
                     data-yellow-src="{{ asset('images/filosofi.bawah.kuning.webp') }}">
            </div>
        </div>

        <!-- Mobile Stacked Layout -->
        <div class="lg:hidden flex flex-col items-center gap-12 w-full">
            <img src="{{ asset('images/filosofi.text.webp') }}" alt="Filosofi Text" class="w-full max-w-[280px] mt-8">
            
            <div class="flex flex-col items-center text-center gap-4 w-full max-w-md px-2">
                <img src="{{ asset('images/filosofi.atas.kuning.webp') }}" class="w-44 petir-glow filter drop-shadow-[0_0_12px_rgba(248,215,148,0.5)]">
            ...
            <div class="flex flex-col items-center text-center gap-4 w-full max-w-md px-2">
                <img src="{{ asset('images/filosofi.bawah.kuning.webp') }}" class="w-44 petir-glow filter drop-shadow-[0_0_12px_rgba(248,215,148,0.5)]">
