...
export const SECTIONS = {
  ...
  buku: {
      label: 'BUKU ANGKATAN',
      aspects: [
        { name:'Journey to DTEI', max:15, guide:'Maksimum 15 poin (panduan).' },
        { name:'CV', max:10, guide:'Maksimum 10 poin (panduan).' },
        { name:'Mind Map', max:10, guide:'Maksimum 10 poin (panduan).' },
        { name:'Struktur Organisasi', max:5, guide:'Maksimum 5 poin (panduan).' },
        { name:'Dosen DTEI', max:20, guide:'Maksimum 20 poin (panduan).' },
        { name:'Denah', max:5, guide:'Maksimum 5 poin (panduan).' },
  ...
  partisipasi: {
      label: 'PARTISIPASI',
      aspects: [
        { name:'Dewan Komunal', max:35, guide:'Maksimum 35 poin.' },
        { name:'Seven Segment', max:50, guide:'Maksimum 50 poin.' },
        { name:'Coffe Offering', max:15, guide:'Maksimum 15 poin.' },
        { name:'Techno Extro Time ', max:35, guide:'Maksimum 35 poin.' },
        { name:'Staff Muda', max:25, guide:'Maksimum 25 poin.' },
        { name:'Arak-Arakan', max:20, guide:'Maksimum 20 poin.' },
        { name:'Elektro Cup', max:15, guide:'Maksimum 15 poin.' },
        { name:'Admin IG Angkatan', max:50, guide:'Maksimum 50 poin.' },
        { name:'Admin IG Offering', max:30, guide:'Maksimum 30 poin.' },
      ],
      noteMax:275,
    },
};
